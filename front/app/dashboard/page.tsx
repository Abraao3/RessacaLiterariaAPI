      ...
      <div style={{ display: "flex" }}>
        ...
        <main style={{ flex: 1, padding: "1rem" }}>
          <div className="flex flex-row justify-center gap-3 border-b-1 b-black pb-3 mb-3">
            <div
              className="px-4 bg-white rounded-xl hover:shadow-sm hover:shadow-black cursor-pointer"
            ...
            <div
              className="px-4 bg-white rounded-xl hover:shadow-sm hover:shadow-black cursor-pointer"
              onClick={() => handleClick("privacidade")}
            >
              Privacidade
            </div>
          ...
          <div id="pages">
            {aba === "perfil" && (
              <div className="page" id="pagePerfil">
                <PerfilInfo
                  usuario={usuario}
            ...
            {aba === "senha" && (
              <div className="page" id="pageSenha">
                <AlterarSenha />
              </div>
            )}

            {aba === "notificacoes" && (
              <div className="page" id="pageNotifica">
                <Notificacoes />
              </div>
            )}

            {aba === "privacidade" && (
              <div className="page" id="pagePriva">
                <Privacidade />
              </div>
            )}

            {aba === "biblioteca" && (
              <div className="page" id="pageBib">
                <BibliotecaPessoal />
              </div>
            )}
          </div>
